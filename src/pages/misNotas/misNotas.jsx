    ...
    <div className="g-container">
      ...
      <main className="buttonAdd-container">
        <button className="buttonAdd" onClick={handleClickModalAddNotes}>
          <img src={Plus} className="icon-add" alt="add-product" />{" "}
        </button>
      </main>
      ...
      <CardNotes
        notes={existingNotes}
        clickModalDelete={handleClickModalDelete}
        clickModalEdit={handleClickModalEdit}
      ></CardNotes>
      {showModalDelete && (
        <ModalDelete handleClickDelete={handleClickDelete} cancel={cancel} />
      )}
      {showModalEdit && (
        <ModalEdit
          notes={existingNotes.find((note) => note.id === selectedId)}
          cancel={cancel}
        />
      )}
    </div>
